...
@DataJpaTest
public class TestDbDiscoverersTable {
    ...
    void testPlanetsTable() throws SQLException {
        ...
        expectedResult.add("OCCUPATION,CHARACTER VARYING,1,null,255");
        expectedResult.add("NATIONALITY,CHARACTER VARYING,0,null,255");

        ResultSet columns = metaData.getColumns(null, "PUBLIC", "DISCOVERERS", null);
