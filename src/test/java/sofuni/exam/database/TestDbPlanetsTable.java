...
@DataJpaTest
public class TestDbPlanetsTable {
    ...
    void testPlanetsTable() throws SQLException {
        ...
        expectedResult.add("DIAMETER,INTEGER,0,null,32");
        expectedResult.add("ORBITAL_PERIOD,DOUBLE PRECISION,0,null,53");
        expectedResult.add("DISTANCE_FROM_SUN,BIGINT,0,null,64");

        ResultSet columns = metaData.getColumns(null, "PUBLIC", "PLANETS", null);
