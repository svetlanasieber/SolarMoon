...
public class TestDbColumnNames {
    ...
    void columnsNames() throws SQLException {
        ...
        expectedResult.add("NATIONALITY");
        expectedResult.add("OCCUPATION");
        expectedResult.add("DISCOVERED");
        expectedResult.add("DISCOVERER_ID");
        expectedResult.add("DISTANCE_FROM_PLANET");
        expectedResult.add("ID");
        expectedResult.add("NAME");
        expectedResult.add("PLANET_ID");
        expectedResult.add("RADIUS");
        expectedResult.add("DIAMETER");
        expectedResult.add("DISTANCE_FROM_SUN");
        expectedResult.add("ID");
        expectedResult.add("NAME");
        expectedResult.add("ORBITAL_PERIOD");
